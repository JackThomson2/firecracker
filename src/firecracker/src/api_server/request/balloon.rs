...
mod tests {
    ...
    fn test_parse_patch_balloon_request() {
        ...
        assert_eq!(
            vmm_action_from_request(parse_patch_balloon(Some(&Body::new(body)), [].into_iter()).unwrap()),
        ...
        // PATCH stop hinting invalid path
        parse_patch_balloon(Some(&Body::new("")), ["hinting", "other path"].into_iter()).unwrap_err();
